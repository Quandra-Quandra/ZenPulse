...
6. You can minimize that window and go to the XAMPP folder, then xamppfiles and go to the htdocs folder. Delete the contents in there and drag the ZenPulse folder in there. Make sure the venv folder (from canvas) is inside the ZenPulse folder
